...
cat.addEventListener('transitionend', (e) => {
  if (e.propertyName === 'top' && cat.classList.contains('start')) {
    ...
    showDialog("Приві! Я - кіт. Сподіваюся ти досягла успіхів у своїх цілях. Я вважаю, що для досягнення мети головне мати людей, які будуть тебе мотивувати до роботи і завжди підтримають. (Лісова мудрість)");
  }
});


function showDialog(text, speed =100) {
