...
cat.addEventListener('transitionend', (e) => {
  if (e.propertyName === 'top' && cat.classList.contains('start')) {
    ...
    showDialog("Приві! Я - кіт. Сподіваюся ти досягла успіхів у своїх цілях. Головне у роботі - мотивація. Без неї я б ніколи так швидко не зробив цей сайт. Вірю, що ти знайдеш свою.");
  }
});
